...
const Getdp = () => {
  return (
      <div className="py-8 px-4 md:px-12 lg:px-24">
          ...
          {/* Navbar section */}
          <div className="mb-24 border-b border-neutral-700/80 pb-8">
          ...
          {/* Main section */}
          <div className="getdp-section py-12 px-8 space-y-8 mb-24 ">
          ...
          <div className="footer flex flex-col gap-8 justify-center items-center border-t border-neutral-700/80 py-24">
